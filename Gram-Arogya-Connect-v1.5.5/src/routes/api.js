...
const recordShareController = require('../controllers/recordShareController');
...
router.post('/profile/share', userAuth.requireAuth, recordShareController.createShare);
router.get('/shared-record/:token', recordShareController.readShare);
