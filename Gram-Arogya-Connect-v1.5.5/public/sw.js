const CACHE='gram-arogya-v1.5.7-qr1'; const ASSETS=['/','/index.html','/css/style.css','/js/app.js','/images/sunita-tai.webp','/images/gram-arogya-connect-logo.png','/manifest.webmanifest','/doctor.html','/js/doctor.js'];
