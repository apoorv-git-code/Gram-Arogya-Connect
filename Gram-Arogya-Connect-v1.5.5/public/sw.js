const CACHE='gram-arogya-v1.5.6'; const ASSETS=['/','/index.html','/css/style.css','/js/app.js','/images/sunita-tai.webp','/images/gram-arogya-connect-logo.png','/manifest.webmanifest'];
