...
## v1.5.4 changes
- Patient/ASHA role selection appears only during account creation.
- Login identifies the stored account role automatically from MongoDB.
- Remembered login hints store only the login ID, never the role or password.
